...
export default defineConfig({
    ...
    extends: blogTheme,
    // 仓库名
    // base: '/zexi.li.github.io/',
    lang: 'zh-cn',
    title: 'zexi.li - 兴安安国, 自立立人',
    ...
    vite: {
        plugins: [
            ...
            SponsorPlugin({
                 ...
                 */
                type: 'simple',
                aliPayQR: 'https://www.zexi.li.com/img/aliPayQR.png',
                weChatQR: 'https://www.zexi.li.com/img/weChatQR.png'
            })
        ]
    },
    sitemap: {
        hostname: 'https://www.zexi.li.com'
    },
    locales: {
        root: {
          label: '简体中文',
